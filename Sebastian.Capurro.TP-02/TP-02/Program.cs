...
namespace TP_02
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            Leche m2 = new Leche(Producto.EMarca.Serenisima, "IOP852", ConsoleColor.Blue);//se quita , Leche.ETipo.Descremada parametro por que no tiene un constructor con 4 params
